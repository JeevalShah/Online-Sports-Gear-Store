...
-- PRODUCT's TABLE
INSERT INTO PRODUCT (PID, PDes, PPrice, PName, PBrand, PQuantity, SID) VALUES
(300, 'Waterproof ski jacket', 120.99, 'Ski Jacket', 'NorthFace', 20, 200),
(301, 'Insulated snow boots', 89.50, 'Snow Boots', 'Columbia', 15, 200),
(302, 'Thermal gloves', 25.75, 'Winter Gloves', 'The Heat Co.', 50, 200),
(303, 'Ski Goggles with UV protection', 49.99, 'Ski Goggles', 'Oakley', 30, 201),
(304, 'Snowboard', 299.99, 'All-Mountain Snowboard', 'Burton', 10, 201),
(305, 'Woolen beanie hat', 18.49, 'Beanie Hat', 'Patagonia', 40, 202),
(306, 'Winter hiking socks', 12.99, 'Thermal Socks', 'Smartwool', 60, 202),
(307, 'Fleece-lined ski pants', 99.99, 'Ski Pants', 'Arc’teryx', 25, 203),
(308, 'Heated hand warmers', 15.99, 'Hand Warmers', 'HotHands', 100, 203),
(309, 'Winter backpack for skiing', 149.99, 'Ski Backpack', 'Osprey', 12, 204),
(310, 'Snowboard helmet', 134.95, 'Helmet', 'Smith', 20, 205),
(311, 'Ski poles', 45.99, 'Ski Poles', 'Leki', 35, 205),
(312, 'Base layer thermal shirt', 35.99, 'Thermal Shirt', 'Under Armour', 45, 206),
(313, 'Snowshoes for deep snow', 199.99, 'Snowshoes', 'MSR', 15, 207),
(314, 'Gore-Tex winter gloves', 79.99, 'Gore-Tex Gloves', 'Black Diamond', 30, 208);
